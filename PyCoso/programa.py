...
# Lista de 20 ejercicios pertenecientes a Q con resultados "lindos"
EJERCICIOS = [
    ...
    {"index": 2, "num": 36,  "den": 81,  "ans": Fraction(2, 3)},  # 6/9 o 2/3
    ...
    {"index": 2, "num": 64,  "den": 4,   "ans": Fraction(4, 1)},  # 64/4 = 16 -> raiz = 4
...
def mostrar_teoria():
    ...
    print("-> 'La raiz se reparte arriba y abajo'.")
    print("   Para calcular la raiz de una fraccion, calculamos la raiz")
    print("   del numerador (arriba) y la raiz del denominador (abajo).")
    print("\nPara que sirve esta propiedad?")
    print("-> Evita hacer divisiones con coma incomodas dentro de la raiz.")
    print("   Calculamos dos raices exactas conocidas y obtenemos")
    print("   un resultado limpio y facil en Q.")
    print("="*60 + "\n")
    ...
    for i, ej in enumerate(EJERCICIOS, 1):
        ...
        while True:
            ...
            if parsed == ej["ans"]:
                ...
                # Requisito: decir solamente si esta bien o mal y pedir que intenten otra vez SIN dar la respuesta
